...
(function () {
  ...
  fetch(new URL("partials/sidebar.html", root).href)
    ...
    .catch(function () {
      host.innerHTML =
        '<p style="padding:12px;font-size:12px;color:#888;font-family:var(--font-mono)">Serve this folder over http(s) (e.g. <code style="color:#e07060">python3 -m http.server 3007</code> or <code style="color:#e07060">./serve.sh</code>) so <code style="color:#e07060">partials/sidebar.html</code> loads. Avoid <code style="color:#e07060">file://</code>.</p>';
    });
})();
