      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl mb-6" style={{ color: '#888888' }}>
            Understand B-Trees, write-ahead logging, query planning, MVCC, and more through hands-on exploration.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                title: 'MVCC',
                href: '/chapters/mvcc',
                description: 'Multi-Version Concurrency Control visualization.',
                icon: '📚',
                color: '#f59e0b'
              },
              {
                title: 'Index Comparison',
                href: '/chapters/index-comparison',
                description: 'Compare B-Tree, Hash, and GiST index performance.',
                icon: '📊',
                color: '#ec4899'
              },
              {
                title: 'Buffer Management',
                href: '/chapters/buffer-management',
                description: 'Learn how databases manage memory and disk I/O.',
                icon: '💾',
                color: '#5ba3b5'
              }
            ].map((chapter) => (
        ...
        <div className="mt-16 pt-8 border-t" style={{ borderColor: '#333333' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Link href="/chapters/mvcc" className="p-4 rounded-lg hover-overlay block" style={{ background: '#1a1918', border: '1px solid #333333', textDecoration: 'none' }}>
              <div className="flex items-center gap-3">
                <span className="text-2xl">📚</span>
                <div>
                  <div className="font-semibold" style={{ color: '#e7e5e2' }}>MVCC</div>
                  <div className="text-sm" style={{ color: '#888888' }}>Multi-version concurrency control</div>
                </div>
              </div>
            </Link>
            <Link href="/chapters/index-comparison" className="p-4 rounded-lg hover-overlay block" style={{ background: '#1a1918', border: '1px solid #333333', textDecoration: 'none' }}>
              <div className="flex items-center gap-3">
                <span className="text-2xl">📊</span>
                <div>
                  <div className="font-semibold" style={{ color: '#e7e5e2' }}>Index Comparison</div>
                  <div className="text-sm" style={{ color: '#888888' }}>B-Tree vs Hash vs GiST performance</div>
                </div>
              </div>
            </Link>
            <Link href="/chapters/buffer-management" className="p-4 rounded-lg hover-overlay block" style={{ background: '#1a1918', border: '1px solid #333333', textDecoration: 'none' }}>
              <div className="flex items-center gap-3">
                <span className="text-2xl">💾</span>
                <div>
                  <div className="font-semibold" style={{ color: '#e7e5e2' }}>Buffer Management</div>
                  <div className="text-sm" style={{ color: '#888888' }}>Memory management and disk I/O</div>
                </div>
              </div>
            </Link>
          </div>
